...
#
#       This file is version $Revision: 345 $ 
#                       from $Date: 2010-01-28 11:37:03 -0500 (Thu, 28 Jan 2010) $
...
# semi-standalones
#
#/usr/bin/python buildMacGato.py -v --python=/usr/bin/python -a --standalone build
#
# NOTE: --python=/usr/bin/pythonw produces pesky Python name in application menu
#
