#!/bin/sh
#
# Version of xvfb-run patched for MacOS X; from 
# http://www.hexten.com/wiki/index.php/Patch_xvfb-run_for_Mac_OS_X
#
# I have seen the Debian xvfb-run licensed under GPL; there is no
