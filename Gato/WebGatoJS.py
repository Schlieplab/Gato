...
function Initialize(evt) {
    ...
    movie_slider = new MovieSlider('movie_slider', 1000-x_offset-getTranslate(action_panel.llc.group.getAttribute("transform"))[0]-action_panel.llc.group.getBBox().width, 30, x_offset, total_time, [['onmousedown', 'Click_MovieSlider(evt)']]);
